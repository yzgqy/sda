...
public class TaskController {
    ...
    public ResponseEntity queryTasks( String appId,@RequestParam(defaultValue = "1") Integer pageNum, @RequestParam(defaultValue = "10") Integer pageSize) {
        TaskEntity taskEntity = new TaskEntity();
        taskEntity.setAppId(appId);
        taskEntity.setType("InfoCollection");
        PageQueryDto<TaskEntity> dto = taskService.queryTaskInfoCollection(taskEntity, PageQueryDto.create(pageNum, pageSize));
        return ResponseEntity.ok(dto);
    }
}
