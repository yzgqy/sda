...
public class Generate {
    ...
    public File generateJar() throws Exception{
        ...
        Process p1 = Runtime.getRuntime().exec("chmod 777"+file.getAbsolutePath()+START_UP_SHELL_FILE);
        CommandResult commandResult1 = CommandUtils.exec(file.getAbsolutePath()+START_UP_SHELL_FILE);
        System.out.println(commandResult1.getOutputForString());
        System.out.println(commandResult1.getErrorOutputForString());
//        File file = new File("/Users/yaya/Desktop/tmp/tmp/task_InfoCollection/200424878TY37NTC/plugin/20042487391941427200");
        modifyJavaFile(file);
        writeAllClassFile(file);
        Process p2 = Runtime.getRuntime().exec("chmod 777"+file.getAbsolutePath()+"/"+getPluginName()+BUILD_SHELL_FILE);
        CommandResult commandResult2 = CommandUtils.exec(file.getAbsolutePath()+"/"+getPluginName()+BUILD_SHELL_FILE);
